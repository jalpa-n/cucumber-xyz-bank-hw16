Feature: Bank Test
  ...
  Scenario: User as a bank manager should able to add customer successfully
    ...
    And I enter First name "Jalpa" to First Name field
    And I enter Last Name "Ganatra" to Last Name Field
    And I enter Postcode "NN18 8FW" to Postcode Field
  ...
  Scenario: User as a bank manager should able to open account successfully
    ...
    And I select "Jalpa Ganatra" customer name which added before
  ...
  Scenario: User should be able to login into the account logout fro the account successfully
    ...
    And I should be able able to verify customer name "Jalpa Ganatra"
